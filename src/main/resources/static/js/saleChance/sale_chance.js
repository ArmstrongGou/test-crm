layui.use(['form', 'jquery', 'jquery_cookie', 'table'], function () {
    ...
    var tableIns = table.render({
        ...
        limits: [10, 15, 20, 25],
        limit: 10,
        toolbar: "#toolbarDemo",   /*#表示绑定toolbar即头部工具栏绑定sale_chance.ftl里面的id=toobarDemo*/
        ...
        ]]    /*#saleChanceListBar表示绑定sale_chance里面的行工具栏*/
    });
    ...
    $(".search_btn").click(function () {
        ...
        table.reload('saleChanceListTable', {
            where: { //设定异步数据接口的额外参数，任意设
                //通过文本框、下拉框的值设置传递的参数
                customerName: $("input[name='customerName']").val(), //客户名称的值
